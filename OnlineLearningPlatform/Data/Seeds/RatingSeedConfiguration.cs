    ...
    public class RatingSeedConfiguration : IEntityTypeConfiguration<Ratings>
    {
        ...
        private static List<Ratings> GetRatings()
        {
            var list = new List<Ratings>
            {
                ...
                new Ratings { RatingId = 5, Rating = 4, Feedback = "Well structured and clear.", CourseId = 3, UserId = "6", DateCreated = new DateTime(2025, 3, 7) },
                new Ratings { RatingId = 6, Rating = 5, Feedback = "Loved the practical examples.", CourseId = 3, UserId = "7", DateCreated = new DateTime(2025, 3, 8) },

                new Ratings { RatingId = 7, Rating = 2, Feedback = "Too basic for me.", CourseId = 4, UserId = "6", DateCreated = new DateTime(2025, 3, 9) },
                new Ratings { RatingId = 8, Rating = 4, Feedback = "Good for beginners.", CourseId = 4, UserId = "7", DateCreated = new DateTime(2025, 3, 10) },

                new Ratings { RatingId = 9, Rating = 5, Feedback = "Outstanding course!", CourseId = 5, UserId = "6", DateCreated = new DateTime(2025, 3, 11) },
                new Ratings { RatingId = 10, Rating = 4, Feedback = "Enjoyed the teaching style.", CourseId = 5, UserId = "7", DateCreated = new DateTime(2025, 3, 12) },
            };
